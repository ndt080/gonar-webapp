  ...
  <footer>
    <div class="content">
      <div class="footer-column footer-column-common">
        <p class="footer-column-header">Карта сайта</p>
        <h1 class="footer-column-body">
      ...
      <div class="footer-column footer-column-about">
        ...
        <p class="footer-column-body">{{data?.Content}}</p>
      </div>
    </div>
    <div class="content">
      <div class="bottom-footer">
        <p>Copyright ©2021 All rights reserved | Developed by <span style="color: #ea0763">Petrov Andrei</span></p>
        <div>
          <a href="">
...
export default {
  ...
  computed: {
    data() {
      let hh = this.$store.getters.pages.find(x => x['GUID'] === 'home-footer')
...
.footer-column-body, .footer-column-body a{
  font-size: 1em;
  font-weight: 300;
  line-height: 1.2;
  color: #8f8f8f;
